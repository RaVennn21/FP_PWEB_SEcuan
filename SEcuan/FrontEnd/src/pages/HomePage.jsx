...
export default function Home({ onSelectGame }) {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/gamecards")
      .then((res) => res.json())
      .then((data) => {
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <section className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 mb-2">
            Your Ultimate Gaming Top-Up Platform
          </p>
          <p className="text-sm text-gray-400 max-w-2xl mx-auto">
            Get instant top-ups for your favorite games. Secure, fast, and
            reliable.
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">
                Get your top-ups within seconds
              </p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-3">🔒</div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">
                Competitive rates on all packages
              </p>
            </div>
          </div>
        </section>
